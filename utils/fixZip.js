...
// ADD MOST RECENT CAMPSITE DATA HERE
const campsiteData = [
  {
...
// MAP DATA INTO A NEW ARRAY LEADING ZERO ADDED TO ZIP CODES LESS THAN 5 CHARACTERS
const test = campsiteData.map((element) => ({
  ...
  state: element.state,
  zipCode:
    `${element.zipCode}`.length < 5
      ? `0${element.zipCode}`
      : `${element.zipCode}`,
  city: element.city,
  address: element.address,
  nameState: element.nameState,
}));
// console.log(test);
